...
const Frontend = () => {
    return (
        ...
        >
            ...
            <div className="frontend h-full flex flex-col items items-center border-1 border-amber-50 p-7 rounded-4xl bg-gray-900 shadow-[0_0_15px_5px_rgba(168,85,247,0.7)] ]">

    ...
    <>
      <div className="text-amber-50 flex flex-col mt-50 gap-15 relative items-center ">
        <div className="flex flex-col gap-8 items-center" >
          ...
          <div className="font-medium text-lg text-gray-400">A showcase of my technical expertise and skills developed through hands-on projects and real-world experience.</div>
        </div>
